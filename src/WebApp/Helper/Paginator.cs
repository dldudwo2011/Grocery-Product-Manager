...
namespace WebApp.Helper
{
    ...
    public class Paginator : IEnumerable<PageRef>
    {
        ...
        public int PageCount 
        {
            get
            {
                if (TotalItemCount % CurrentState.PageSize != 0)
                {
                    return (TotalItemCount / CurrentState.PageSize) + 1;
                }
                else
                {
                    return TotalItemCount / CurrentState.PageSize;
                }
            }
        }
        ...
        public int LastDigit { get { return LastPage % CurrentState.PageSize; } }
